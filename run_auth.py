...
lname = 'log/'+bucket_key+'_run_auth.log'
logging.basicConfig(filename=lname, level=logging.INFO, format='%(asctime)s %(message)s')


config = {'in_fspec': 'scripts/'+bucket_key+'_out_auth.sql', 'log': lname, 'export_type': 'csv', 'conn_type': 'tgt', 'function': 'pools', 'bucket_key': bucket_key}
