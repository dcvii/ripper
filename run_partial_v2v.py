...
lname = 'log/migrate_'+bucket_key+'_'+schema+'_partial_v2v.log'
...
if is_valid_schema(schema):
    ...
    cmd_set = chunkify('scripts/'+bucket_key+'_'+schema+'_partial.sql')
    config = {'in_fspec': 'nil', 'log': lname, 'export_type': 'parquet', 'schema': schema,
         'conn_type': 'tgt', 'function': 'partial_v2v', 'bucket_key': bucket_key}
