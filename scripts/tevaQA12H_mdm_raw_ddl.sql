...
AS
 ...
 ORDER BY license.tvcmid,
          ...
          license.file_id,
          license.record_id
SEGMENTED BY hash(license.record_id) ALL NODES;
...
AS
 ...
 ORDER BY communication.tvcmid,
          ...
          communication.file_id,
          communication.record_id
SEGMENTED BY hash(communication.record_id) ALL NODES;

CREATE PROJECTION mdm.email_preference_b0 /*+basename(email_preference),createtype(L)*/ 
(
 tvcmid,
 email,
 value,
...
AS
 SELECT email_preference.tvcmid,
        email_preference.email,
        email_preference.value,
        email_preference.effective_date,
        email_preference.created_by,
        email_preference.created_date,
        email_preference.updated_by,
        email_preference.updated_date,
        email_preference.file_id,
        email_preference.record_id
 FROM mdm.email_preference
 ORDER BY email_preference.tvcmid,
          email_preference.email,
          email_preference.value,
          email_preference.effective_date,
          email_preference.created_by,
          ...
          email_preference.file_id,
          email_preference.record_id
SEGMENTED BY hash(email_preference.record_id) ALL NODES;
...
AS
 ...
 ORDER BY professional.tvcmid,
          ...
          professional.file_id,
          professional.record_id
SEGMENTED BY hash(professional.record_id) ALL NODES;
...
AS
 ...
 ORDER BY alternate_name.tvcmid,
          ...
          alternate_name.file_id,
          alternate_name.record_id
SEGMENTED BY hash(alternate_name.record_id) ALL NODES;
...
AS
 ...
 ORDER BY hco_teva_flag.tvcmid,
          ...
          hco_teva_flag.file_id,
          hco_teva_flag.record_id
SEGMENTED BY hash(hco_teva_flag.record_id) ALL NODES;
...
AS
 ...
 ORDER BY dea_address.tvcmid,
          ...
          dea_address.file_id,
          dea_address.record_id
SEGMENTED BY hash(dea_address.record_id) ALL NODES;
...
AS
 ...
 ORDER BY raw_npi.tvcmid,
          ...
          raw_npi.file_id,
          raw_npi.record_id
SEGMENTED BY hash(raw_npi.record_id) ALL NODES;
...
AS
 ...
 ORDER BY alternate_id.tvcmid,
          ...
          alternate_id.file_id,
          alternate_id.record_id
SEGMENTED BY hash(alternate_id.record_id) ALL NODES;
...
AS
 ...
 ORDER BY hco.tvcmid,
          ...
          hco.file_id,
          hco.record_id
SEGMENTED BY hash(hco.record_id) ALL NODES;
...
AS
 ...
 ORDER BY hcp_teva_flag.tvcmid,
          ...
          hcp_teva_flag.file_id,
          hcp_teva_flag.record_id
SEGMENTED BY hash(hcp_teva_flag.record_id) ALL NODES;
...
AS
 ...
 ORDER BY relationship.hierarchy_code,
          ...
          relationship.file_id,
          relationship.record_id
SEGMENTED BY hash(relationship.record_id) ALL NODES;
...
AS
 ...
 ORDER BY hcp.tvcmid,
          ...
          hcp.file_id,
          hcp.record_id
SEGMENTED BY hash(hcp.record_id) ALL NODES;
...
AS
 ...
 ORDER BY specialty.tvcmid,
          ...
          specialty.file_id,
          specialty.record_id
SEGMENTED BY hash(specialty.record_id) ALL NODES;
...
AS
 ...
 ORDER BY source_details.tvcmid,
          ...
          source_details.file_id,
          source_details.record_id
SEGMENTED BY hash(source_details.record_id) ALL NODES;
...
AS
 ...
 ORDER BY address_link.tvcmid,
          ...
          address_link.file_id,
          address_link.record_id
SEGMENTED BY hash(address_link.record_id) ALL NODES;
...
AS
 ...
 ORDER BY regulation.state_license_type_id,
          ...
          regulation.file_id,
          regulation.record_id
SEGMENTED BY hash(regulation.record_id) ALL NODES;
...
CREATE PROJECTION mdm.marketing_channel_b0 /*+basename(marketing_channel),createtype(L)*/ 
(
 tvcmid,
 channel,
 value,
...
AS
 SELECT marketing_channel.tvcmid,
        marketing_channel.channel,
        marketing_channel.value,
        marketing_channel.effective_date,
        marketing_channel.created_by,
        marketing_channel.created_date,
        marketing_channel.updated_by,
        marketing_channel.updated_date,
        marketing_channel.file_id,
        marketing_channel.record_id
 FROM mdm.marketing_channel
 ORDER BY marketing_channel.tvcmid,
          marketing_channel.channel,
          marketing_channel.value,
          marketing_channel.effective_date,
          marketing_channel.created_by,
          ...
          marketing_channel.file_id,
          marketing_channel.record_id
SEGMENTED BY hash(marketing_channel.record_id) ALL NODES;
...
AS
 ...
 ORDER BY merges.previous_tvcmid,
          ...
          merges.file_id,
          merges.record_id
SEGMENTED BY hash(merges.record_id) ALL NODES;
