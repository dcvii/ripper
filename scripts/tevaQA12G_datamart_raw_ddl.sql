...
CREATE PROJECTION datamart.sfa_call_new_b0 /*+basename(sfa_call_new),createtype(A)*/ 
(
 sales_force_id,
 call_id,
 veeva_account_id,
...
AS
 SELECT sfa_call_new.sales_force_id,
        sfa_call_new.call_id,
        sfa_call_new.veeva_account_id,
        sfa_call_new.ims_id,
        sfa_call_new.ims_outlet_id,
        sfa_call_new.customer_type,
        sfa_call_new.first_name,
        sfa_call_new.last_name,
        sfa_call_new.call_type,
        sfa_call_new.legacy_call_type,
        sfa_call_new.ceph_id,
        sfa_call_new.dea_num,
        sfa_call_new.rep_id,
        sfa_call_new.rep_first_name,
        sfa_call_new.rep_last_name,
        sfa_call_new.territory_number,
        sfa_call_new.zip_on_call,
        sfa_call_new.call_date,
        sfa_call_new.submit_date,
        sfa_call_new.attendees,
        sfa_call_new.attendee_type,
        sfa_call_new.area_number,
        sfa_call_new.region_number,
        sfa_call_new.tvcmid,
        sfa_call_new.call_recordtype,
        sfa_call_new.call_duration,
        sfa_call_new.call_datetime,
        sfa_call_new.call_timezone,
        sfa_call_new.how_executed,
        sfa_call_new.remote_meeting_id,
        sfa_call_new.parent_call_id,
        sfa_call_new.is_parent_call,
        sfa_call_new.t21s10_austedo_indication
 FROM datamart.sfa_call_new
 ORDER BY sfa_call_new.sales_force_id,
          sfa_call_new.call_id,
          sfa_call_new.veeva_account_id,
          sfa_call_new.ims_id,
          sfa_call_new.ims_outlet_id,
          ...
          sfa_call_new.first_name,
          sfa_call_new.last_name
SEGMENTED BY hash(sfa_call_new.sales_force_id, sfa_call_new.territory_number, sfa_call_new.call_date, sfa_call_new.submit_date, sfa_call_new.attendees, sfa_call_new.area_number, sfa_call_new.region_number, sfa_call_new.tvcmid) ALL NODES;
