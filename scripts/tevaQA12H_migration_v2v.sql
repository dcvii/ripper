...
COPY /*2031*/ migration.source_schemas_history FROM VERTICA teva.migration.source_schemas_history;
COPY /*96734*/ migration.users_only_src FROM VERTICA teva.migration.users_only_src;
COPY /*107056*/ migration.grants_src FROM VERTICA teva.migration.grants_src;
