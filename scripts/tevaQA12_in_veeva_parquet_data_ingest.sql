...
COPY veeva.survey_question FROM 's3://teva-export-buckt/tevaQA12/veeva/survey_question/*' PARQUET;
COPY veeva.medical_event FROM 's3://teva-export-buckt/tevaQA12/veeva/medical_event/*' PARQUET;
COPY veeva.rep_roster FROM 's3://teva-export-buckt/tevaQA12/veeva/rep_roster/*' PARQUET;
COPY veeva.userterritory2association FROM 's3://teva-export-buckt/tevaQA12/veeva/userterritory2association/*' PARQUET;
COPY veeva.suggestion_feedback FROM 's3://teva-export-buckt/tevaQA12/veeva/suggestion_feedback/*' PARQUET;
COPY veeva.territory2 FROM 's3://teva-export-buckt/tevaQA12/veeva/territory2/*' PARQUET;
COPY veeva.dsa_slide FROM 's3://teva-export-buckt/tevaQA12/veeva/dsa_slide/*' PARQUET;
COPY veeva.dsa_presentation FROM 's3://teva-export-buckt/tevaQA12/veeva/dsa_presentation/*' PARQUET;
COPY veeva.group FROM 's3://teva-export-buckt/tevaQA12/veeva/group/*' PARQUET;
COPY veeva.approved_document FROM 's3://teva-export-buckt/tevaQA12/veeva/approved_document/*' PARQUET;
COPY veeva.product FROM 's3://teva-export-buckt/tevaQA12/veeva/product/*' PARQUET;
COPY veeva.assessment FROM 's3://teva-export-buckt/tevaQA12/veeva/assessment/*' PARQUET;
COPY veeva.key_message FROM 's3://teva-export-buckt/tevaQA12/veeva/key_message/*' PARQUET;
COPY veeva.suggestion FROM 's3://teva-export-buckt/tevaQA12/veeva/suggestion/*' PARQUET;
COPY veeva.veeva_user FROM 's3://teva-export-buckt/tevaQA12/veeva/veeva_user/*' PARQUET;
...
COPY veeva.survey_target FROM 's3://teva-export-buckt/tevaQA12/veeva/survey_target/*' PARQUET;
COPY veeva.time_off_territory FROM 's3://teva-export-buckt/tevaQA12/veeva/time_off_territory/*' PARQUET;
COPY veeva.call_sample FROM 's3://teva-export-buckt/tevaQA12/veeva/call_sample/*' PARQUET;
COPY veeva.call_key_message FROM 's3://teva-export-buckt/tevaQA12/veeva/call_key_message/*' PARQUET;
COPY veeva.affiliation FROM 's3://teva-export-buckt/tevaQA12/veeva/affiliation/*' PARQUET;
COPY veeva.call_clickstream FROM 's3://teva-export-buckt/tevaQA12/veeva/call_clickstream/*' PARQUET;
COPY veeva.account FROM 's3://teva-export-buckt/tevaQA12/veeva/account/*' PARQUET;
...
COPY veeva.call_history FROM 's3://teva-export-buckt/tevaQA12/veeva/call_history/*' PARQUET;
COPY veeva.ids_call FROM 's3://teva-export-buckt/tevaQA12/veeva/ids_call/*' PARQUET;
COPY veeva.ids_call_detail FROM 's3://teva-export-buckt/tevaQA12/veeva/ids_call_detail/*' PARQUET;
