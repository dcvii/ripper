...
COPY /*47538267*/ outbound.asi_ims_presc_demo FROM VERTICA teva.outbound.asi_ims_presc_demo;
COPY /*119667862*/ outbound.asi_xponent_demographics FROM VERTICA teva.outbound.asi_xponent_demographics;
COPY /*132945828*/ outbound.market_presc_zip_divisor FROM VERTICA teva.outbound.market_presc_zip_divisor;
DISCONNECT teva;
