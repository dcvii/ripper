...
CREATE PROJECTION payerspine.mb_test_b0 /*+basename(mb_test),createtype(L)*/ 
(
 test
)
AS
 SELECT mb_test.test
 FROM payerspine.mb_test
 ORDER BY mb_test.test
SEGMENTED BY hash(mb_test.test) ALL NODES;

CREATE PROJECTION payerspine.PS_KEY_CONTROLLER_LIST_V01_b0 /*+basename(PS_KEY_CONTROLLER_LIST_V01),createtype(L)*/ 
(
 ftf_health_plan_fid,
...
AS
 SELECT PS_KEY_CONTROLLER_LIST_V01.ftf_health_plan_fid,
        PS_KEY_CONTROLLER_LIST_V01.ftf_health_plan_name,
        PS_KEY_CONTROLLER_LIST_V01.key_controlling_account,
        PS_KEY_CONTROLLER_LIST_V01.key_controlling_plan_formulary,
        PS_KEY_CONTROLLER_LIST_V01.key_controlling_parent,
        PS_KEY_CONTROLLER_LIST_V01.payer_pbm,
        PS_KEY_CONTROLLER_LIST_V01.file_id,
        PS_KEY_CONTROLLER_LIST_V01.record_id
 FROM payerspine.PS_KEY_CONTROLLER_LIST_V01
 ORDER BY PS_KEY_CONTROLLER_LIST_V01.ftf_health_plan_fid,
          PS_KEY_CONTROLLER_LIST_V01.ftf_health_plan_name,
          PS_KEY_CONTROLLER_LIST_V01.key_controlling_account,
          PS_KEY_CONTROLLER_LIST_V01.key_controlling_plan_formulary,
          PS_KEY_CONTROLLER_LIST_V01.key_controlling_parent,
          ...
          PS_KEY_CONTROLLER_LIST_V01.file_id,
          PS_KEY_CONTROLLER_LIST_V01.record_id
SEGMENTED BY hash(PS_KEY_CONTROLLER_LIST_V01.ftf_health_plan_fid, PS_KEY_CONTROLLER_LIST_V01.file_id, PS_KEY_CONTROLLER_LIST_V01.record_id, PS_KEY_CONTROLLER_LIST_V01.payer_pbm, PS_KEY_CONTROLLER_LIST_V01.ftf_health_plan_name, PS_KEY_CONTROLLER_LIST_V01.key_controlling_account, PS_KEY_CONTROLLER_LIST_V01.key_controlling_plan_formulary, PS_KEY_CONTROLLER_LIST_V01.key_controlling_parent) ALL NODES;

CREATE PROJECTION payerspine.PS_PROVIDER_OVERRIDE_DEFAULT_V01_b0 /*+basename(PS_PROVIDER_OVERRIDE_DEFAULT_V01),createtype(L)*/ 
(
 provider_id,
 paytype_regex,
 provider_name,
...
AS
 SELECT PS_PROVIDER_OVERRIDE_DEFAULT_V01.provider_id,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.paytype_regex,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.provider_name,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.fill_in_iqvia_payer_name_if_no_bridge,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.override_best_iqvia_payer,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.fill_in_iqvia_pbm_if_no_bridge,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.override_best_iqvia_pbm,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.file_id,
        PS_PROVIDER_OVERRIDE_DEFAULT_V01.record_id
 FROM payerspine.PS_PROVIDER_OVERRIDE_DEFAULT_V01
 ORDER BY PS_PROVIDER_OVERRIDE_DEFAULT_V01.provider_id,
          PS_PROVIDER_OVERRIDE_DEFAULT_V01.paytype_regex,
          PS_PROVIDER_OVERRIDE_DEFAULT_V01.provider_name,
          PS_PROVIDER_OVERRIDE_DEFAULT_V01.fill_in_iqvia_payer_name_if_no_bridge,
          PS_PROVIDER_OVERRIDE_DEFAULT_V01.override_best_iqvia_payer,
          ...
          PS_PROVIDER_OVERRIDE_DEFAULT_V01.override_best_iqvia_pbm,
          PS_PROVIDER_OVERRIDE_DEFAULT_V01.file_id
SEGMENTED BY hash(PS_PROVIDER_OVERRIDE_DEFAULT_V01.provider_id, PS_PROVIDER_OVERRIDE_DEFAULT_V01.file_id, PS_PROVIDER_OVERRIDE_DEFAULT_V01.record_id, PS_PROVIDER_OVERRIDE_DEFAULT_V01.paytype_regex, PS_PROVIDER_OVERRIDE_DEFAULT_V01.provider_name, PS_PROVIDER_OVERRIDE_DEFAULT_V01.fill_in_iqvia_payer_name_if_no_bridge, PS_PROVIDER_OVERRIDE_DEFAULT_V01.override_best_iqvia_payer, PS_PROVIDER_OVERRIDE_DEFAULT_V01.fill_in_iqvia_pbm_if_no_bridge) ALL NODES;

CREATE PROJECTION payerspine.ftf_pbms_6mofiles_b0 /*+basename(ftf_pbms_6mofiles),createtype(L)*/ 
(
 health_plan_id,
 pbm_id,
 pbm,
...
AS
 SELECT ftf_pbms_6mofiles.health_plan_id,
        ftf_pbms_6mofiles.pbm_id,
        ftf_pbms_6mofiles.pbm,
        ftf_pbms_6mofiles.pbm_function_id,
        ftf_pbms_6mofiles.pbm_function,
        ftf_pbms_6mofiles.month_id
 FROM payerspine.ftf_pbms_6mofiles
 ORDER BY ftf_pbms_6mofiles.health_plan_id,
          ftf_pbms_6mofiles.pbm_id,
          ftf_pbms_6mofiles.pbm,
          ftf_pbms_6mofiles.pbm_function_id,
          ftf_pbms_6mofiles.pbm_function,
          ftf_pbms_6mofiles.month_id
SEGMENTED BY hash(ftf_pbms_6mofiles.health_plan_id, ftf_pbms_6mofiles.pbm_id, ftf_pbms_6mofiles.pbm, ftf_pbms_6mofiles.pbm_function_id, ftf_pbms_6mofiles.pbm_function, ftf_pbms_6mofiles.month_id) ALL NODES;

CREATE PROJECTION payerspine.ftf_health_plans_6mofiles_b0 /*+basename(ftf_health_plans_6mofiles),createtype(L)*/ 
(
 formularyf_id,
 provider_id,
 provider,
...
AS
 SELECT ftf_health_plans_6mofiles.formularyf_id,
        ftf_health_plans_6mofiles.provider_id,
        ftf_health_plans_6mofiles.provider,
        ftf_health_plans_6mofiles.health_plan_id,
        ftf_health_plans_6mofiles.health_plan,
        ftf_health_plans_6mofiles.parent_id,
        ftf_health_plans_6mofiles.parent,
        ftf_health_plans_6mofiles.national_lives_count,
        ftf_health_plans_6mofiles.plan_type_name,
        ftf_health_plans_6mofiles.preferred_brand_tier,
        ftf_health_plans_6mofiles.month_id
 FROM payerspine.ftf_health_plans_6mofiles
 ORDER BY ftf_health_plans_6mofiles.formularyf_id,
          ftf_health_plans_6mofiles.provider_id,
          ftf_health_plans_6mofiles.provider,
          ftf_health_plans_6mofiles.health_plan_id,
          ftf_health_plans_6mofiles.health_plan,
          ...
          ftf_health_plans_6mofiles.parent,
          ftf_health_plans_6mofiles.national_lives_count
SEGMENTED BY hash(ftf_health_plans_6mofiles.national_lives_count, ftf_health_plans_6mofiles.formularyf_id, ftf_health_plans_6mofiles.provider_id, ftf_health_plans_6mofiles.health_plan_id, ftf_health_plans_6mofiles.parent_id, ftf_health_plans_6mofiles.parent, ftf_health_plans_6mofiles.plan_type_name, ftf_health_plans_6mofiles.preferred_brand_tier) ALL NODES;

CREATE PROJECTION payerspine.mc_wb_new_view_6mofiles_b0 /*+basename(mc_wb_new_view_6mofiles),createtype(L)*/ 
(
 payer_num,
 payer_name,
 plan_num,
...
AS
 SELECT mc_wb_new_view_6mofiles.payer_num,
        mc_wb_new_view_6mofiles.payer_name,
        mc_wb_new_view_6mofiles.plan_num,
        mc_wb_new_view_6mofiles.payer_plan_num,
        mc_wb_new_view_6mofiles.plan_name,
        mc_wb_new_view_6mofiles.model,
        mc_wb_new_view_6mofiles.city,
        mc_wb_new_view_6mofiles.hq_state,
        mc_wb_new_view_6mofiles.operating_state,
        mc_wb_new_view_6mofiles.months_with_data,
        mc_wb_new_view_6mofiles.month_id
 FROM payerspine.mc_wb_new_view_6mofiles
 ORDER BY mc_wb_new_view_6mofiles.payer_num,
          mc_wb_new_view_6mofiles.payer_name,
          mc_wb_new_view_6mofiles.plan_num,
          mc_wb_new_view_6mofiles.payer_plan_num,
          mc_wb_new_view_6mofiles.plan_name,
          ...
          mc_wb_new_view_6mofiles.city,
          mc_wb_new_view_6mofiles.hq_state
SEGMENTED BY hash(mc_wb_new_view_6mofiles.payer_num, mc_wb_new_view_6mofiles.payer_name, mc_wb_new_view_6mofiles.plan_num, mc_wb_new_view_6mofiles.payer_plan_num, mc_wb_new_view_6mofiles.plan_name, mc_wb_new_view_6mofiles.model, mc_wb_new_view_6mofiles.city, mc_wb_new_view_6mofiles.hq_state) ALL NODES;

CREATE PROJECTION payerspine.mc_wb_pbm_plans_6mofiles_b0 /*+basename(mc_wb_pbm_plans_6mofiles),createtype(L)*/ 
(
 pbm_name,
 payer_plan_id,
...
AS
 SELECT mc_wb_pbm_plans_6mofiles.pbm_name,
        mc_wb_pbm_plans_6mofiles.payer_plan_id,
        mc_wb_pbm_plans_6mofiles.xref_to_payer_plan_id,
        mc_wb_pbm_plans_6mofiles.ipd_id,
        mc_wb_pbm_plans_6mofiles.ipd_type,
        mc_wb_pbm_plans_6mofiles.plan_name,
        mc_wb_pbm_plans_6mofiles.pbm_id,
        mc_wb_pbm_plans_6mofiles.ims_processor_number,
        mc_wb_pbm_plans_6mofiles.month_id
 FROM payerspine.mc_wb_pbm_plans_6mofiles
 ORDER BY mc_wb_pbm_plans_6mofiles.pbm_name,
          mc_wb_pbm_plans_6mofiles.payer_plan_id,
          mc_wb_pbm_plans_6mofiles.xref_to_payer_plan_id,
          mc_wb_pbm_plans_6mofiles.ipd_id,
          mc_wb_pbm_plans_6mofiles.ipd_type,
          ...
          mc_wb_pbm_plans_6mofiles.pbm_id,
          mc_wb_pbm_plans_6mofiles.ims_processor_number
SEGMENTED BY hash(mc_wb_pbm_plans_6mofiles.pbm_name, mc_wb_pbm_plans_6mofiles.payer_plan_id, mc_wb_pbm_plans_6mofiles.xref_to_payer_plan_id, mc_wb_pbm_plans_6mofiles.ipd_id, mc_wb_pbm_plans_6mofiles.ipd_type, mc_wb_pbm_plans_6mofiles.plan_name, mc_wb_pbm_plans_6mofiles.pbm_id, mc_wb_pbm_plans_6mofiles.ims_processor_number) ALL NODES;

CREATE PROJECTION payerspine.ftf_ims_bridge_6mofiles_b0 /*+basename(ftf_ims_bridge_6mofiles),createtype(L)*/ 
(
 payer_name,
 code,
 name,
...
AS
 SELECT ftf_ims_bridge_6mofiles.payer_name,
        ftf_ims_bridge_6mofiles.code,
        ftf_ims_bridge_6mofiles.name,
        ftf_ims_bridge_6mofiles.state,
        ftf_ims_bridge_6mofiles.comments,
        ftf_ims_bridge_6mofiles.plan_id,
        ftf_ims_bridge_6mofiles.plan_name,
        ftf_ims_bridge_6mofiles.provider_name,
        ftf_ims_bridge_6mofiles.plan_type_name,
        ftf_ims_bridge_6mofiles.month
 FROM payerspine.ftf_ims_bridge_6mofiles
 ORDER BY ftf_ims_bridge_6mofiles.payer_name,
          ftf_ims_bridge_6mofiles.code,
          ftf_ims_bridge_6mofiles.name,
          ftf_ims_bridge_6mofiles.state,
          ftf_ims_bridge_6mofiles.comments,
          ...
          ftf_ims_bridge_6mofiles.plan_name,
          ftf_ims_bridge_6mofiles.provider_name
SEGMENTED BY hash(ftf_ims_bridge_6mofiles.payer_name, ftf_ims_bridge_6mofiles.code, ftf_ims_bridge_6mofiles.name, ftf_ims_bridge_6mofiles.state, ftf_ims_bridge_6mofiles.comments, ftf_ims_bridge_6mofiles.plan_id, ftf_ims_bridge_6mofiles.plan_type_name, ftf_ims_bridge_6mofiles.month) ALL NODES;

CREATE PROJECTION payerspine.ftf_formularies_6mofiles_b0 /*+basename(ftf_formularies_6mofiles),createtype(L)*/ 
(
 health_plan_id,
 drug_id,
 tier_code,
...
AS
 SELECT ftf_formularies_6mofiles.health_plan_id,
        ftf_formularies_6mofiles.drug_id,
        ftf_formularies_6mofiles.tier_code,
        ftf_formularies_6mofiles.restrictions,
        ftf_formularies_6mofiles.reason_code,
        ftf_formularies_6mofiles.reason_code_description,
        ftf_formularies_6mofiles.pharmacy_status,
        ftf_formularies_6mofiles.month_id
 FROM payerspine.ftf_formularies_6mofiles
 ORDER BY ftf_formularies_6mofiles.health_plan_id,
          ftf_formularies_6mofiles.drug_id,
          ftf_formularies_6mofiles.tier_code,
          ftf_formularies_6mofiles.restrictions,
          ftf_formularies_6mofiles.reason_code,
          ...
          ftf_formularies_6mofiles.pharmacy_status,
          ftf_formularies_6mofiles.month_id
SEGMENTED BY hash(ftf_formularies_6mofiles.health_plan_id, ftf_formularies_6mofiles.drug_id, ftf_formularies_6mofiles.tier_code, ftf_formularies_6mofiles.restrictions, ftf_formularies_6mofiles.reason_code, ftf_formularies_6mofiles.reason_code_description, ftf_formularies_6mofiles.pharmacy_status, ftf_formularies_6mofiles.month_id) ALL NODES;

CREATE PROJECTION payerspine.ftf_health_plan_geography_6mofiles_b0 /*+basename(ftf_health_plan_geography_6mofiles),createtype(L)*/ 
(
 health_plan_id,
 county_fips_id,
 county_id,
...
AS
 SELECT ftf_health_plan_geography_6mofiles.health_plan_id,
        ftf_health_plan_geography_6mofiles.county_fips_id,
        ftf_health_plan_geography_6mofiles.county_id,
        ftf_health_plan_geography_6mofiles.county_name,
        ftf_health_plan_geography_6mofiles.state_id,
        ftf_health_plan_geography_6mofiles.state_name,
        ftf_health_plan_geography_6mofiles.county_lives,
        ftf_health_plan_geography_6mofiles.month_id,
        ftf_health_plan_geography_6mofiles.file_id_v1,
        ftf_health_plan_geography_6mofiles.record_id
 FROM payerspine.ftf_health_plan_geography_6mofiles
 ORDER BY ftf_health_plan_geography_6mofiles.health_plan_id,
          ftf_health_plan_geography_6mofiles.county_fips_id,
          ftf_health_plan_geography_6mofiles.county_id,
          ftf_health_plan_geography_6mofiles.county_name,
          ftf_health_plan_geography_6mofiles.state_id,
          ...
          ftf_health_plan_geography_6mofiles.county_lives,
          ftf_health_plan_geography_6mofiles.month_id
SEGMENTED BY hash(ftf_health_plan_geography_6mofiles.health_plan_id, ftf_health_plan_geography_6mofiles.county_fips_id, ftf_health_plan_geography_6mofiles.county_id, ftf_health_plan_geography_6mofiles.state_id, ftf_health_plan_geography_6mofiles.file_id_v1, ftf_health_plan_geography_6mofiles.record_id, ftf_health_plan_geography_6mofiles.county_lives, ftf_health_plan_geography_6mofiles.month_id) ALL NODES;

CREATE PROJECTION payerspine.ftf_restrictions_v2_6mofiles_b0 /*+basename(ftf_restrictions_v2_6mofiles),createtype(L)*/ 
(
 health_plan_id,
 drug_id,
 restriction_code,
...
AS
 SELECT ftf_restrictions_v2_6mofiles.health_plan_id,
        ftf_restrictions_v2_6mofiles.drug_id,
        ftf_restrictions_v2_6mofiles.restriction_code,
        ftf_restrictions_v2_6mofiles.restriction_details_id,
        ftf_restrictions_v2_6mofiles.restriction_details_text,
        ftf_restrictions_v2_6mofiles.restriction_details_information_1,
        ftf_restrictions_v2_6mofiles.restriction_details_information_2,
        ftf_restrictions_v2_6mofiles.step_count,
        ftf_restrictions_v2_6mofiles.pa_form,
        ftf_restrictions_v2_6mofiles.indication,
        ftf_restrictions_v2_6mofiles.grouped_restriction_level,
        ftf_restrictions_v2_6mofiles.month_id
 FROM payerspine.ftf_restrictions_v2_6mofiles
 ORDER BY ftf_restrictions_v2_6mofiles.health_plan_id,
          ftf_restrictions_v2_6mofiles.drug_id,
          ftf_restrictions_v2_6mofiles.restriction_code,
          ftf_restrictions_v2_6mofiles.restriction_details_id,
          ftf_restrictions_v2_6mofiles.restriction_details_text,
          ...
          ftf_restrictions_v2_6mofiles.restriction_details_information_2,
          ftf_restrictions_v2_6mofiles.step_count
SEGMENTED BY hash(ftf_restrictions_v2_6mofiles.health_plan_id, ftf_restrictions_v2_6mofiles.drug_id, ftf_restrictions_v2_6mofiles.restriction_details_id, ftf_restrictions_v2_6mofiles.month_id, ftf_restrictions_v2_6mofiles.restriction_code, ftf_restrictions_v2_6mofiles.step_count, ftf_restrictions_v2_6mofiles.indication, ftf_restrictions_v2_6mofiles.restriction_details_information_2) ALL NODES;
