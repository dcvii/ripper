...
CREATE TABLE payerspine.ftf_restriction_id_group_mapping_v2
(
...
CREATE TABLE payerspine.grouped_rest_ranking_control
(
    restriction_group varchar(15000),
    rank_rest_grp int
);
...
CREATE TABLE payerspine.ftf_formularies_preprocessed_cdw_v3
(
    drug_seq int,
...
CREATE TABLE payerspine.ftf_restrictions_preprocessed_cdw_v3
(
    health_plan_id int,
    drug_id int,
    drug_seq int,
...
PARTITION BY (ftf_restrictions_preprocessed_cdw_v3.cycle_id);


CREATE TABLE payerspine.plan_prod_master_cdw_v2
(
    ftf_health_plan_fid int,
...
PARTITION BY (plan_prod_master_cdw_v2.cycle_id);


CREATE TABLE payerspine.ftf_plan_master_file_cdw_v2
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
    ...
    market_access_cvg_w_overides varchar(500),
    calc_coverage_cat_w_overrides varchar(500),
    cycle_id int,
    modified_time timestamp,
    modified_by varchar(100)
)
PARTITION BY (ftf_plan_master_file_cdw_v2.cycle_id);


CREATE TABLE payerspine.iqvia_plans_discard_v01
(
    payer_id int,
    notes varchar(200),
    file_id int,
...
CREATE TABLE payerspine.model_paytype_map_v01
(
    model varchar(100),
    paytype varchar(100),
    notes varchar(200),
...
CREATE TABLE payerspine.iqvia_paytypeindex_v01
(
    paytype_index int,
    paytype varchar(100),
    file_id int,
...
CREATE TABLE payerspine.iqvia_payer_paytype_override_v01
(
    iqvia_payer_name varchar(200),
...
CREATE TABLE payerspine.ftf_plans_paytypeindex_v01
(
...
CREATE TABLE payerspine.ftf_paytype_paytypeindex_v01
(
    paytype_index int,
    paytype varchar(100),
    file_id int,
...
CREATE TABLE payerspine.ftf_override_provider_v01
(
    provider_fid int,
    paytype_index int,
    notes varchar(200),
...
CREATE TABLE payerspine.ftf_override_plan_v01
(
    ftf_health_plan_fid int,
    paytype_index int,
    notes varchar(200),
...
CREATE TABLE payerspine.drug_assignments_v01
(
    drug_id int,
    drug_seq int,
    product varchar(100),
...
CREATE TABLE payerspine.ftf_pbm_functions_v01
(
    pbm_function_id int,
...
CREATE TABLE payerspine.botox_step_restriction_v01
(
    code int,
...
CREATE TABLE payerspine.step_restriction_v01
(
    code int,
...
CREATE TABLE payerspine.pa_restriction_v01
(
    code int,
    prescriber_prior_authorization_category varchar(200),
...
CREATE TABLE payerspine.patient_pa_restriction_v01
(
    code int,
    patient_prior_authorization_category varchar(200),
    restriction_detail_id varchar(100),
...
CREATE TABLE payerspine.medical_rec_restriction_v01
(
    code int,
    medical_records_submission_required_flag varchar(100),
    restriction_detail_id varchar(100),
...
CREATE TABLE payerspine.unspecified_rec_restriction_v01
(
    code int,
    unspecified_restriction_flag varchar(100),
    restriction_detail_id varchar(100),
...
CREATE TABLE payerspine.override_bridge_ftf_plan_types_v01
(
...
CREATE TABLE payerspine.delete_bridge_ftf_plan_types_v01
(
    ftf_health_plan_name_regex varchar(200),
    iqvia_payer_name_regex varchar(200),
    iqvia_plan_name_regex varchar(200),
...
CREATE TABLE payerspine.provider_override_default_v01
(
    provider_id int,
...
CREATE TABLE payerspine.key_controller_list_v01
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    key_controlling_account varchar(200),
...
CREATE TABLE payerspine.calculated_pbm_config_v01
(
...
CREATE TABLE payerspine.calc_pbm_key_pbm_mapping_v01
(
...
CREATE TABLE payerspine.has_pa_mapping_v01
(
    has_pa int,
...
CREATE TABLE payerspine.has_st_mapping_v01
(
    has_st int,
...
CREATE TABLE payerspine.formulary_derivation_config_v01
(
...
CREATE TABLE payerspine.copay_tier_derivation_config_v01
(
    pharmacy_status_regex varchar(200),
    tier_cat int,
    tier_regex varchar(200),
...
CREATE TABLE payerspine.tier_cat_description_mapping_v01
(
    tier_cat int,
...
CREATE TABLE payerspine.restriction_category_derivation_config_v01
(
    tier_regex varchar(200),
...
CREATE TABLE payerspine.restriction_cat_description_mapping_v01
(
...
CREATE TABLE payerspine.coverage_category_derivation_config_v01
(
    paytype_regex varchar(200),
    pharmacy_status_regex varchar(200),
...
CREATE TABLE payerspine.coverage_cat_description_mapping_v01
(
...
CREATE TABLE payerspine.step_restriction_description_v01
(
    step int,
    description varchar(500),
    file_id int,
...
CREATE TABLE payerspine.pres_pa_restriction_description_v01
(
    prespa int,
    description varchar(500),
    file_id int,
...
CREATE TABLE payerspine.pat_pa_restriction_description_v01
(
    patpa int,
    description varchar(500),
    file_id int,
...
CREATE TABLE payerspine.override_fid_iqvia_key_controller_list_v01
(
    iqvia_plan_code int,
...
CREATE TABLE payerspine.payer_spinev3_unique_cdw_v2
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(300),
    iqvia_payer_name varchar(300),
    iqvia_pbm varchar(300),
    pharmacy_benefit_gpo varchar(300),
    ...
    digi_proair_access_for_ftf_plan varchar(200),
    digi_airduo_access_for_ftf_plan varchar(200),
    digi_armonair_access_for_ftf_plan varchar(200)
)
PARTITION BY (payer_spinev3_unique_cdw_v2.cycle_id);


CREATE TABLE payerspine.payer_spinev3_detailed_cdw_v2
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(300),
    iqvia_payer_name varchar(300),
...
PARTITION BY (payer_spinev3_detailed_cdw_v2.cycle_id);


CREATE TABLE payerspine.iqvia_plan_preprocessed_cdw_v1
(
    iqvia_payer_id int,
    iqvia_payer_name varchar(200),
    iqvia_plan_id int,
...
CREATE TABLE payerspine.iqvia_pbm_preprocessed_cdw_v1
(
    iqvia_plan_code int,
    iqvia_pbm varchar(200),
    xref_to varchar(200),
...
CREATE TABLE payerspine.ftf_health_plans_preprocessed_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.ftf_formularies_preprocessed_cdw_v1
(
    drug_seq int,
    ftf_health_plan_fid int,
    drug_id int,
...
CREATE TABLE payerspine.ftf_pbms_preprocessed_cdw_v1
(
    ftf_health_plan_fid int,
    pbm_id int,
    pbm varchar(500),
...
CREATE TABLE payerspine.ftf_restrictions_preprocessed_cdw_v1
(
    ftf_health_plan_fid int,
    drug_id int,
...
CREATE TABLE payerspine.ftf_restrictions_preprocessed_cdw_v2
(
    ftf_health_plan_fid int,
    drug_id int,
    drug_seq int,
...
CREATE TABLE payerspine.ftf_iqvia_bridge_preprocessed_cdw_v1
(
    iqvia_payer_name varchar(200),
    iqvia_plan_code int,
    iqvia_plan_name varchar(200),
...
CREATE TABLE payerspine.iqvia_plancode_fid_xref_cdw_v1
(
    iqvia_payer_name varchar(200),
    iqvia_plan_code int,
    iqvia_plan_name varchar(200),
...
CREATE TABLE payerspine.fid_best_iqviapayer_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.fid_best_iqviapbm_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.amb4_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ...
    old_coverage_category_digi_proair varchar(200),
    old_coverage_category_digi_airduo varchar(200),
    old_coverage_category_digi_armonair varchar(200)
)
PARTITION BY (amb4_cdw_v1.cycle_id);


CREATE TABLE payerspine.amb4_iqvia_payer_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.amb4_iqvia_pbm_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.amb7_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.ftf_hpid_keypbm_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_name varchar(200),
...
CREATE TABLE payerspine.plan_prod_master_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.ftf_plan_master_file_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.pivot_plan_prod_master_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
    ...
    coverage_category_digi_proair varchar(200),
    coverage_category_digi_airduo varchar(200),
    coverage_category_digi_armonair varchar(200)
)
PARTITION BY (pivot_plan_prod_master_cdw_v1.cycle_id);


CREATE TABLE payerspine.comparison_ftf_health_plan_fid_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    ftf_provider_fid int,
...
CREATE TABLE payerspine.ftf_iqvia_xref_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(200),
    ...
    nurtec_access_for_ftf_plan varchar(300),
    qulipta_access_for_ftf_plan varchar(300),
    austedo_hd_access_for_ftf_plan varchar(300),
    austedo_td_access_for_ftf_plan varchar(300),
    ingrezza_td_access_for_ftf_plan varchar(300),
    digi_proair_access_for_ftf_plan varchar(300),
    digi_airduo_access_for_ftf_plan varchar(300),
    digi_armonair_access_for_ftf_plan varchar(300)
)
PARTITION BY (ftf_iqvia_xref_cdw_v1.cycle_id);


CREATE TABLE payerspine.ftf_iqvia_xref_v2_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(200),
    iqvia_payer_name varchar(200),
...
CREATE TABLE payerspine.comparison_iqvia_fid_plans_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(200),
    ftf_health_plan_fid int,
...
CREATE TABLE payerspine.access_master_bridge_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(200),
    coverage_category_ajovy varchar(200),
...
CREATE TABLE payerspine.iqvia_plan_code_ftf_hp_id_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(300),
    iqvia_payer_name varchar(300),
...
CREATE TABLE payerspine.key_ctl_account_summary_cdw_v1
(
    paytype varchar(200),
...
CREATE TABLE payerspine.key_pbm_summary_cdw_v1
(
    paytype varchar(200),
    ftf_health_plan_type varchar(300),
    key_pbm varchar(300),
...
CREATE TABLE payerspine.iqvia_payer_name_summary_cdw_v1
(
    paytype varchar(300),
    iqvia_payer_name varchar(300),
    current_month_lives int,
...
CREATE TABLE payerspine.iqvia_pbm_summary_cdw_v1
(
    paytype varchar(300),
    iqvia_pbm varchar(300),
    current_month_lives int,
...
CREATE TABLE payerspine.ftf_formulary_management_pbm_summary_cdw_v1
(
    paytype varchar(300),
    ftf_formulary_management_pbm varchar(300),
    current_month_lives int,
...
CREATE TABLE payerspine.ftf_formulary_influencer_pbm_summary_cdw_v1
(
    paytype varchar(300),
    ftf_formulary_influencer_pbm varchar(300),
    current_month_lives int,
...
CREATE TABLE payerspine.ftf_claims_processing_pbm_summary_cdw_v1
(
    paytype varchar(300),
    ftf_claims_processing_pbm varchar(300),
    current_month_lives int,
...
CREATE TABLE payerspine.st_lives_summary_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(300),
...
CREATE TABLE payerspine.ftf_hp_id_key_controlling_account_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(300),
    ftf_provider_name varchar(300),
...
CREATE TABLE payerspine.ftf_hp_id_key_pbm_cdw_v1
(
    ftf_health_plan_fid int,
    ftf_health_plan_name varchar(300),
    ftf_provider_name varchar(300),
...
CREATE TABLE payerspine.ftf_plan_master_file_op_cdw_v1
(
    ftf_health_plan_fid int,
    product varchar(200),
    ftf_health_plan_name varchar(300),
...
CREATE TABLE payerspine.paytype_product_coverage_category_cdw_v1
(
    paytype varchar(300),
    product varchar(300),
    metric varchar(300),
...
CREATE TABLE payerspine.paytype_product_copay_tier_cdw_v1
(
    paytype varchar(300),
    product varchar(300),
    metric varchar(300),
...
CREATE TABLE payerspine.paytype_product_step_category_cdw_v1
(
    paytype varchar(300),
    product varchar(300),
    metric varchar(300),
...
CREATE TABLE payerspine.paytype_product_patient_pa_cdw_v1
(
    paytype varchar(300),
    product varchar(300),
    metric varchar(300),
...
CREATE TABLE payerspine.key_controlling_account_product_cov_category_paytype_cdw_v1
(
    key_controlling_account varchar(300),
    paytype varchar(300),
    product varchar(300),
...
CREATE TABLE payerspine.key_pbm_product_cov_category_paytype_cdw_v1
(
    key_pbm varchar(300),
    paytype varchar(300),
    product varchar(300),
...
CREATE TABLE payerspine.payer_spine25_detailed_teva_brands_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(300),
    iqvia_payer_name varchar(300),
...
CREATE TABLE payerspine.payer_spine25_plan_teva_brands_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(300),
    iqvia_payer_name varchar(300),
...
CREATE TABLE payerspine.comparison_payer_spine_cdw_v1
(
    iqvia_plan_code int,
    iqvia_plan_name varchar(300),
    iqvia_payer_name varchar(300),
...
CREATE TABLE payerspine.parent_process_execution
(
...
CREATE TABLE payerspine.process_info
(
    sub_process_id int,
...
CREATE TABLE payerspine.process_audit_tbl
(
    process_id int,
    cycle_id int,
    date_run date,
...
CREATE TABLE payerspine.tbl_lvl_audit
(
    process_id int,
    tbl_id varchar(200),
    cycle_id int,
...
CREATE TABLE payerspine.process_dependency_master
(
    process_id int,
...
CREATE TABLE payerspine.tbl_info
(
    tbl_id int,
...
CREATE TABLE payerspine.saba_mkt_ajovy_payer_spine_prod_list
(
...
CREATE TABLE payerspine.past_mapping_changes
(
    Restrictions varchar(300),
    Manual_update varchar(300),
    restrictions_up varchar(300),
    has_pa int,
    has_st int,
    hasPAST int
);
...
CREATE TABLE payerspine.ftf_restriction_id_group_mapping
(
...
PARTITION BY (ftf_restriction_id_group_mapping.record_id);


CREATE PROJECTION payerspine.access_master_bridge_cdw_v1_b0 /*+basename(access_master_bridge_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ...
 coverage_category_digi_proair,
 coverage_category_digi_airduo,
 coverage_category_digi_armonair
)
AS
...
CREATE PROJECTION payerspine.comparison_ftf_health_plan_fid_cdw_v1_b0 /*+basename(comparison_ftf_health_plan_fid_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
AS
 ...
 ORDER BY comparison_ftf_health_plan_fid_cdw_v1.ftf_health_plan_fid,
          comparison_ftf_health_plan_fid_cdw_v1.ftf_health_plan_name,
          comparison_ftf_health_plan_fid_cdw_v1.ftf_provider_fid,
          comparison_ftf_health_plan_fid_cdw_v1.ftf_provider_name,
          comparison_ftf_health_plan_fid_cdw_v1.ftf_parent_name,
...
CREATE PROJECTION payerspine.calc_pbm_key_pbm_mapping_v01_b0 /*+basename(calc_pbm_key_pbm_mapping_v01),createtype(L)*/ 
(
 calculated_pbm,
 key_pbm,
 added_by,
...
CREATE PROJECTION payerspine.calculated_pbm_config_v01_b0 /*+basename(calculated_pbm_config_v01),createtype(L)*/ 
(
...
CREATE PROJECTION payerspine.copay_tier_derivation_config_v01_b0 /*+basename(copay_tier_derivation_config_v01),createtype(L)*/ 
(
...
AS
 ...
 ORDER BY copay_tier_derivation_config_v01.pharmacy_status_regex,
          ...
          copay_tier_derivation_config_v01.file_id,
          copay_tier_derivation_config_v01.record_id
SEGMENTED BY hash(copay_tier_derivation_config_v01.tier_cat, copay_tier_derivation_config_v01.file_id, copay_tier_derivation_config_v01.record_id, copay_tier_derivation_config_v01.pharmacy_status_regex, copay_tier_derivation_config_v01.tier_regex, copay_tier_derivation_config_v01.pref_brand_tier_regex, copay_tier_derivation_config_v01.ftf_health_plan_type_regex, copay_tier_derivation_config_v01.copay_tier) ALL NODES;

CREATE PROJECTION payerspine.coverage_cat_description_mapping_v01_b0 /*+basename(coverage_cat_description_mapping_v01),createtype(L)*/ 
(
 coverage_cat,
 description,
 notes,
...
CREATE PROJECTION payerspine.coverage_category_derivation_config_v01_b0 /*+basename(coverage_category_derivation_config_v01),createtype(L)*/ 
(
 paytype_regex,
 pharmacy_status_regex,
 coverage_cat_code,
...
CREATE PROJECTION payerspine.delete_bridge_ftf_plan_types_v01_b0 /*+basename(delete_bridge_ftf_plan_types_v01),createtype(L)*/ 
(
...
CREATE PROJECTION payerspine.drug_assignments_v01_b0 /*+basename(drug_assignments_v01),createtype(L)*/ 
(
 drug_id,
 drug_seq,
 product,
...
CREATE PROJECTION payerspine.formulary_derivation_config_v01_b0 /*+basename(formulary_derivation_config_v01),createtype(L)*/ 
(
 pharmacy_status_regex,
 has_pa_regex,
 has_st_regex,
...
CREATE PROJECTION payerspine.ftf_override_plan_v01_b0 /*+basename(ftf_override_plan_v01),createtype(L)*/ 
(
 ftf_health_plan_fid,
 paytype_index,
 notes,
...
CREATE PROJECTION payerspine.ftf_override_provider_v01_b0 /*+basename(ftf_override_provider_v01),createtype(L)*/ 
(
 provider_fid,
 paytype_index,
 notes,
...
CREATE PROJECTION payerspine.ftf_paytype_paytypeindex_v01_b0 /*+basename(ftf_paytype_paytypeindex_v01),createtype(L)*/ 
(
 paytype_index,
 paytype,
 file_id,
...
CREATE PROJECTION payerspine.ftf_pbm_functions_v01_b0 /*+basename(ftf_pbm_functions_v01),createtype(L)*/ 
(
 pbm_function_id,
 pbm_function,
 notes,
...
CREATE PROJECTION payerspine.ftf_plans_paytypeindex_v01_b0 /*+basename(ftf_plans_paytypeindex_v01),createtype(L)*/ 
(
 ftf_health_plan_type,
 paytype_index,
 file_id,
...
CREATE PROJECTION payerspine.has_pa_mapping_v01_b0 /*+basename(has_pa_mapping_v01),createtype(L)*/ 
(
 has_pa,
 pa_regex,
 notes,
...
CREATE PROJECTION payerspine.has_st_mapping_v01_b0 /*+basename(has_st_mapping_v01),createtype(L)*/ 
(
 has_st,
 st_regex,
 notes,
...
CREATE PROJECTION payerspine.iqvia_payer_paytype_override_v01_b0 /*+basename(iqvia_payer_paytype_override_v01),createtype(L)*/ 
(
 iqvia_payer_name,
 iqvia_plan_name_regex,
 paytype,
...
CREATE PROJECTION payerspine.iqvia_paytypeindex_v01_b0 /*+basename(iqvia_paytypeindex_v01),createtype(L)*/ 
(
 paytype_index,
 paytype,
 file_id,
...
CREATE PROJECTION payerspine.iqvia_plans_discard_v01_b0 /*+basename(iqvia_plans_discard_v01),createtype(L)*/ 
(
 payer_id,
 notes,
 file_id,
...
CREATE PROJECTION payerspine.key_controller_list_v01_b0 /*+basename(key_controller_list_v01),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 key_controlling_account,
...
CREATE PROJECTION payerspine.medical_rec_restriction_v01_b0 /*+basename(medical_rec_restriction_v01),createtype(L)*/ 
(
 code,
...
CREATE PROJECTION payerspine.model_paytype_map_v01_b0 /*+basename(model_paytype_map_v01),createtype(L)*/ 
(
 model,
 paytype,
 notes,
...
CREATE PROJECTION payerspine.override_bridge_ftf_plan_types_v01_b0 /*+basename(override_bridge_ftf_plan_types_v01),createtype(L)*/ 
(
 ftf_health_plan_name_regex,
 iqvia_payer_name_regex,
 iqvia_plan_name_regex,
...
CREATE PROJECTION payerspine.override_fid_iqvia_key_controller_list_v01_b0 /*+basename(override_fid_iqvia_key_controller_list_v01),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 ftf_health_plan_fid,
...
CREATE PROJECTION payerspine.pa_restriction_v01_b0 /*+basename(pa_restriction_v01),createtype(L)*/ 
(
 code,
...
CREATE PROJECTION payerspine.pat_pa_restriction_description_v01_b0 /*+basename(pat_pa_restriction_description_v01),createtype(L)*/ 
(
 patpa,
 description,
 file_id,
...
CREATE PROJECTION payerspine.patient_pa_restriction_v01_b0 /*+basename(patient_pa_restriction_v01),createtype(L)*/ 
(
 code,
...
CREATE PROJECTION payerspine.pres_pa_restriction_description_v01_b0 /*+basename(pres_pa_restriction_description_v01),createtype(L)*/ 
(
 prespa,
 description,
 file_id,
...
CREATE PROJECTION payerspine.provider_override_default_v01_b0 /*+basename(provider_override_default_v01),createtype(L)*/ 
(
 provider_id,
 paytype_regex,
 provider_name,
...
CREATE PROJECTION payerspine.payer_spine25_detailed_teva_brands_cdw_v1_b0 /*+basename(payer_spine25_detailed_teva_brands_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
...
CREATE PROJECTION payerspine.iqvia_plan_code_ftf_hp_id_cdw_v1_b0 /*+basename(iqvia_plan_code_ftf_hp_id_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
 ...
 digi_proair_access_for_ftf_plan,
 digi_airduo_access_for_ftf_plan,
 digi_armonair_access_for_ftf_plan
)
AS
...
CREATE PROJECTION payerspine.botox_step_restriction_v01_b0 /*+basename(botox_step_restriction_v01),createtype(L)*/ 
(
 code,
 botox_step_flag,
 restriction_group,
...
CREATE PROJECTION payerspine.restriction_cat_description_mapping_v01_b0 /*+basename(restriction_cat_description_mapping_v01),createtype(L)*/ 
(
 rest_cat,
 description,
 notes,
...
CREATE PROJECTION payerspine.restriction_category_derivation_config_v01_b0 /*+basename(restriction_category_derivation_config_v01),createtype(L)*/ 
(
 tier_regex,
 has_pa_has_st_regex,
 unspec_regex,
...
CREATE PROJECTION payerspine.saba_mkt_ajovy_payer_spine_prod_list_b0 /*+basename(saba_mkt_ajovy_payer_spine_prod_list),createtype(L)*/ 
(
 product_name,
 notes,
 file_id,
...
CREATE PROJECTION payerspine.step_restriction_description_v01_b0 /*+basename(step_restriction_description_v01),createtype(L)*/ 
(
 step,
 description,
 file_id,
...
CREATE PROJECTION payerspine.step_restriction_v01_b0 /*+basename(step_restriction_v01),createtype(L)*/ 
(
 code,
 step_category,
 restriction_group,
...
CREATE PROJECTION payerspine.tier_cat_description_mapping_v01_b0 /*+basename(tier_cat_description_mapping_v01),createtype(L)*/ 
(
 tier_cat,
 description,
 notes,
...
AS
 ...
 ORDER BY tier_cat_description_mapping_v01.tier_cat,
          ...
          tier_cat_description_mapping_v01.file_id,
          tier_cat_description_mapping_v01.record_id
SEGMENTED BY hash(tier_cat_description_mapping_v01.tier_cat, tier_cat_description_mapping_v01.file_id, tier_cat_description_mapping_v01.record_id, tier_cat_description_mapping_v01.notes, tier_cat_description_mapping_v01.description) ALL NODES;

CREATE PROJECTION payerspine.unspecified_rec_restriction_v01_b0 /*+basename(unspecified_rec_restriction_v01),createtype(L)*/ 
(
 code,
...
CREATE PROJECTION payerspine.payer_spinev3_detailed_cdw_v2_b0 /*+basename(payer_spinev3_detailed_cdw_v2),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
 iqvia_pbm,
 pharmacy_benefit_gpo,
 key_controlling_plan_formulary,
 key_controlling_account,
 key_controlling_parent,
 payer_pbm,
...
AS
 SELECT payer_spinev3_detailed_cdw_v2.iqvia_plan_code,
        ...
        payer_spinev3_detailed_cdw_v2.cycle_id,
        payer_spinev3_detailed_cdw_v2.modified_time,
        payer_spinev3_detailed_cdw_v2.modified_by,
 ...
 ORDER BY payer_spinev3_detailed_cdw_v2.iqvia_plan_code
SEGMENTED BY hash(payer_spinev3_detailed_cdw_v2.iqvia_plan_code, payer_spinev3_detailed_cdw_v2.lives_plan_kcf_lvl, payer_spinev3_detailed_cdw_v2.lives_plan_lvl, payer_spinev3_detailed_cdw_v2.cycle_id, payer_spinev3_detailed_cdw_v2.modified_time, payer_spinev3_detailed_cdw_v2.apportionment_factor, payer_spinev3_detailed_cdw_v2.saba_trx, payer_spinev3_detailed_cdw_v2.modified_by) ALL NODES;

CREATE PROJECTION payerspine.payer_spinev3_unique_cdw_v2_b0 /*+basename(payer_spinev3_unique_cdw_v2),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
...
AS
 SELECT payer_spinev3_unique_cdw_v2.iqvia_plan_code,
        ...
        payer_spinev3_unique_cdw_v2.cycle_id,
        payer_spinev3_unique_cdw_v2.modified_time,
        payer_spinev3_unique_cdw_v2.modified_by,
 ...
 ORDER BY payer_spinev3_unique_cdw_v2.iqvia_plan_code
SEGMENTED BY hash(payer_spinev3_unique_cdw_v2.iqvia_plan_code) ALL NODES;

CREATE PROJECTION payerspine.ftf_iqvia_bridge_preprocessed_cdw_v1_b0 /*+basename(ftf_iqvia_bridge_preprocessed_cdw_v1),createtype(L)*/ 
(
 iqvia_payer_name,
 iqvia_plan_code,
 iqvia_plan_name,
...
AS
 ...
 ORDER BY ftf_iqvia_bridge_preprocessed_cdw_v1.iqvia_payer_name,
          ftf_iqvia_bridge_preprocessed_cdw_v1.iqvia_plan_code,
          ftf_iqvia_bridge_preprocessed_cdw_v1.iqvia_plan_name,
          ftf_iqvia_bridge_preprocessed_cdw_v1.comments,
          ftf_iqvia_bridge_preprocessed_cdw_v1.ftf_health_plan_fid,
...
CREATE PROJECTION payerspine.parent_process_execution_b0 /*+basename(parent_process_execution),createtype(L)*/ 
(
 parent_process_id,
 parent_process_name,
 date_run,
...
AS
 ...
 ORDER BY parent_process_execution.parent_process_id,
          ...
          parent_process_execution.insert_time,
          parent_process_execution.inserted_by
SEGMENTED BY hash(parent_process_execution.parent_process_id, parent_process_execution.date_run, parent_process_execution.insert_time, parent_process_execution.parent_process_name, parent_process_execution.inserted_by) ALL NODES;

CREATE PROJECTION payerspine.process_audit_tbl_b0 /*+basename(process_audit_tbl),createtype(L)*/ 
(
 process_id,
 cycle_id,
 date_run,
...
AS
 ...
 FROM payerspine.process_audit_tbl
...
CREATE PROJECTION payerspine.process_dependency_master_b0 /*+basename(process_dependency_master),createtype(L)*/ 
(
 process_id,
 process_name,
 tbl_id,
...
AS
 ...
 FROM payerspine.process_dependency_master
 ORDER BY process_dependency_master.process_id,
          ...
          process_dependency_master.insert_time,
          process_dependency_master.inserted_by
SEGMENTED BY hash(process_dependency_master.process_id, process_dependency_master.tbl_id, process_dependency_master.insert_time, process_dependency_master.process_name, process_dependency_master.table_name, process_dependency_master.table_type, process_dependency_master.inserted_by) ALL NODES;

CREATE PROJECTION payerspine.process_info_b0 /*+basename(process_info),createtype(L)*/ 
(
 sub_process_id,
 sub_process_name,
 parent_process_id,
...
AS
 ...
 ORDER BY process_info.sub_process_id,
          ...
          process_info.insert_time,
          process_info.inserted_by
SEGMENTED BY hash(process_info.sub_process_id, process_info.parent_process_id, process_info.insert_time, process_info.sub_process_name, process_info.parent_process_name, process_info.inserted_by) ALL NODES;

CREATE PROJECTION payerspine.tbl_info_b0 /*+basename(tbl_info),createtype(L)*/ 
(
 tbl_id,
 tbl_name,
 insert_time,
...
AS
 ...
 ORDER BY tbl_info.tbl_id,
          ...
          tbl_info.insert_time,
          tbl_info.inserted_by
SEGMENTED BY hash(tbl_info.tbl_id, tbl_info.insert_time, tbl_info.tbl_name, tbl_info.inserted_by) ALL NODES;

CREATE PROJECTION payerspine.comparison_payer_spine_cdw_v1_b0 /*+basename(comparison_payer_spine_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
...
CREATE PROJECTION payerspine.comparison_iqvia_fid_plans_cdw_v1_b0 /*+basename(comparison_iqvia_fid_plans_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 ftf_health_plan_fid,
...
AS
 ...
 ORDER BY comparison_iqvia_fid_plans_cdw_v1.iqvia_plan_code,
          comparison_iqvia_fid_plans_cdw_v1.iqvia_plan_name,
          comparison_iqvia_fid_plans_cdw_v1.ftf_health_plan_fid,
          comparison_iqvia_fid_plans_cdw_v1.ftf_health_plan_name,
          comparison_iqvia_fid_plans_cdw_v1.iqvia_payer_name,
...
CREATE PROJECTION payerspine.ftf_restriction_id_group_mapping_b0 /*+basename(ftf_restriction_id_group_mapping),createtype(L)*/ 
(
 restriction_detail_id,
...
CREATE PROJECTION payerspine.tbl_lvl_audit_b0 /*+basename(tbl_lvl_audit),createtype(L)*/ 
(
 process_id,
 tbl_id,
 cycle_id,
...
AS
 ...
 FROM payerspine.tbl_lvl_audit
 ORDER BY tbl_lvl_audit.process_id,
          tbl_lvl_audit.tbl_id,
          tbl_lvl_audit.cycle_id,
          tbl_lvl_audit.date_run,
          tbl_lvl_audit.inserted_time,
...
CREATE PROJECTION payerspine.iqvia_plan_preprocessed_cdw_v1_b0 /*+basename(iqvia_plan_preprocessed_cdw_v1),createtype(L)*/ 
(
 iqvia_payer_id,
 iqvia_payer_name,
 iqvia_plan_id,
...
CREATE PROJECTION payerspine.iqvia_pbm_preprocessed_cdw_v1_b0 /*+basename(iqvia_pbm_preprocessed_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_pbm,
 xref_to,
...
CREATE PROJECTION payerspine.ftf_health_plans_preprocessed_cdw_v1_b0 /*+basename(ftf_health_plans_preprocessed_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
CREATE PROJECTION payerspine.ftf_formularies_preprocessed_cdw_v1_b0 /*+basename(ftf_formularies_preprocessed_cdw_v1),createtype(L)*/ 
(
 drug_seq,
 ftf_health_plan_fid,
 drug_id,
...
CREATE PROJECTION payerspine.ftf_pbms_preprocessed_cdw_v1_b0 /*+basename(ftf_pbms_preprocessed_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 pbm_id,
 pbm,
...
CREATE PROJECTION payerspine.ftf_restrictions_preprocessed_cdw_v1_b0 /*+basename(ftf_restrictions_preprocessed_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 drug_id,
 restriction_code,
...
CREATE PROJECTION payerspine.ftf_restrictions_preprocessed_cdw_v2_b0 /*+basename(ftf_restrictions_preprocessed_cdw_v2),createtype(L)*/ 
(
 ftf_health_plan_fid,
 drug_id,
 drug_seq,
...
CREATE PROJECTION payerspine.iqvia_plancode_fid_xref_cdw_v1_b0 /*+basename(iqvia_plancode_fid_xref_cdw_v1),createtype(L)*/ 
(
 iqvia_payer_name,
 iqvia_plan_code,
 iqvia_plan_name,
...
CREATE PROJECTION payerspine.fid_best_iqviapayer_cdw_v1_b0 /*+basename(fid_best_iqviapayer_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
CREATE PROJECTION payerspine.fid_best_iqviapbm_cdw_v1_b0 /*+basename(fid_best_iqviapbm_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
CREATE PROJECTION payerspine.amb4_cdw_v1_b0 /*+basename(amb4_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ...
 old_coverage_category_digi_proair,
 old_coverage_category_digi_airduo,
 old_coverage_category_digi_armonair
)
AS
...
CREATE PROJECTION payerspine.amb4_iqvia_payer_cdw_v1_b0 /*+basename(amb4_iqvia_payer_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
CREATE PROJECTION payerspine.amb4_iqvia_pbm_cdw_v1_b0 /*+basename(amb4_iqvia_pbm_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
SEGMENTED BY hash(amb4_iqvia_pbm_cdw_v1.ftf_health_plan_fid, amb4_iqvia_pbm_cdw_v1.ftf_provider_fid, amb4_iqvia_pbm_cdw_v1.paytype_index, amb4_iqvia_pbm_cdw_v1.pref_brand_tier, amb4_iqvia_pbm_cdw_v1.fillIn_blank_iqpayer, amb4_iqvia_pbm_cdw_v1.fillIn_blank_iqpbm, amb4_iqvia_pbm_cdw_v1.ftf_match_iqvia, amb4_iqvia_pbm_cdw_v1.lives_mn) ALL NODES;

CREATE PROJECTION payerspine.amb7_cdw_v1_b0 /*+basename(amb7_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
SEGMENTED BY hash(amb7_cdw_v1.ftf_health_plan_fid, amb7_cdw_v1.ftf_provider_fid, amb7_cdw_v1.paytype_index, amb7_cdw_v1.pref_brand_tier, amb7_cdw_v1.fillIn_blank_iqpayer, amb7_cdw_v1.fillIn_blank_iqpbm, amb7_cdw_v1.ftf_match_iqvia, amb7_cdw_v1.lives_mn) ALL NODES;

CREATE PROJECTION payerspine.ftf_hpid_keypbm_cdw_v1_b0 /*+basename(ftf_hpid_keypbm_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_name,
...
AS
 ...
 ORDER BY ftf_hpid_keypbm_cdw_v1.ftf_health_plan_fid,
          ...
          ftf_hpid_keypbm_cdw_v1.paytype,
          ftf_hpid_keypbm_cdw_v1.iqvia_pbm
SEGMENTED BY hash(ftf_hpid_keypbm_cdw_v1.ftf_health_plan_fid, ftf_hpid_keypbm_cdw_v1.cycle_id, ftf_hpid_keypbm_cdw_v1.modified_time, ftf_hpid_keypbm_cdw_v1.modified_by, ftf_hpid_keypbm_cdw_v1.ftf_health_plan_name, ftf_hpid_keypbm_cdw_v1.ftf_provider_name, ftf_hpid_keypbm_cdw_v1.paytype, ftf_hpid_keypbm_cdw_v1.iqvia_pbm) ALL NODES;

CREATE PROJECTION payerspine.plan_prod_master_cdw_v1_b0 /*+basename(plan_prod_master_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
AS
 ...
 ORDER BY plan_prod_master_cdw_v1.ftf_health_plan_fid,
          plan_prod_master_cdw_v1.drug_seq
SEGMENTED BY hash(plan_prod_master_cdw_v1.ftf_health_plan_fid, plan_prod_master_cdw_v1.drug_seq) ALL NODES;

CREATE PROJECTION payerspine.ftf_plan_master_file_cdw_v1_b0 /*+basename(ftf_plan_master_file_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
AS
 ...
 ORDER BY ftf_plan_master_file_cdw_v1.ftf_health_plan_fid,
          ...
          ftf_plan_master_file_cdw_v1.drug_id,
          ftf_plan_master_file_cdw_v1.drug_seq
SEGMENTED BY hash(ftf_plan_master_file_cdw_v1.ftf_health_plan_fid, ftf_plan_master_file_cdw_v1.drug_seq) ALL NODES;

CREATE PROJECTION payerspine.pivot_plan_prod_master_cdw_v1_b0 /*+basename(pivot_plan_prod_master_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
SEGMENTED BY hash(pivot_plan_prod_master_cdw_v1.ftf_health_plan_fid, pivot_plan_prod_master_cdw_v1.ftf_provider_fid, pivot_plan_prod_master_cdw_v1.paytype_index, pivot_plan_prod_master_cdw_v1.lives_mn, pivot_plan_prod_master_cdw_v1.pref_brand_tier, pivot_plan_prod_master_cdw_v1.prev_lives, pivot_plan_prod_master_cdw_v1.ftf_match_iqvia, pivot_plan_prod_master_cdw_v1.cycle_id) ALL NODES;

CREATE PROJECTION payerspine.ftf_iqvia_xref_cdw_v1_b0 /*+basename(ftf_iqvia_xref_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
...
CREATE PROJECTION payerspine.ftf_iqvia_xref_v2_cdw_v1_b0 /*+basename(ftf_iqvia_xref_v2_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
...
CREATE PROJECTION payerspine.key_ctl_account_summary_cdw_v1_b0 /*+basename(key_ctl_account_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 ftf_health_plan_type,
 key_controlling_account,
...
CREATE PROJECTION payerspine.key_pbm_summary_cdw_v1_b0 /*+basename(key_pbm_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 ftf_health_plan_type,
 key_pbm,
...
CREATE PROJECTION payerspine.iqvia_payer_name_summary_cdw_v1_b0 /*+basename(iqvia_payer_name_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 iqvia_payer_name,
 current_month_lives,
...
CREATE PROJECTION payerspine.iqvia_pbm_summary_cdw_v1_b0 /*+basename(iqvia_pbm_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 iqvia_pbm,
 current_month_lives,
...
CREATE PROJECTION payerspine.ftf_formulary_management_pbm_summary_cdw_v1_b0 /*+basename(ftf_formulary_management_pbm_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 ftf_formulary_management_pbm,
 current_month_lives,
...
CREATE PROJECTION payerspine.ftf_formulary_influencer_pbm_summary_cdw_v1_b0 /*+basename(ftf_formulary_influencer_pbm_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 ftf_formulary_influencer_pbm,
 current_month_lives,
...
CREATE PROJECTION payerspine.ftf_claims_processing_pbm_summary_cdw_v1_b0 /*+basename(ftf_claims_processing_pbm_summary_cdw_v1),createtype(L)*/ 
(
 paytype,
 ftf_claims_processing_pbm,
 current_month_lives,
...
CREATE PROJECTION payerspine.st_lives_summary_cdw_v1_b0 /*+basename(st_lives_summary_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_name,
...
CREATE PROJECTION payerspine.ftf_hp_id_key_controlling_account_cdw_v1_b0 /*+basename(ftf_hp_id_key_controlling_account_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_name,
...
CREATE PROJECTION payerspine.ftf_hp_id_key_pbm_cdw_v1_b0 /*+basename(ftf_hp_id_key_pbm_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_name,
...
CREATE PROJECTION payerspine.ftf_plan_master_file_op_cdw_v1_b0 /*+basename(ftf_plan_master_file_op_cdw_v1),createtype(L)*/ 
(
 ftf_health_plan_fid,
 product,
 ftf_health_plan_name,
...
SEGMENTED BY hash(ftf_plan_master_file_op_cdw_v1.ftf_health_plan_fid, ftf_plan_master_file_op_cdw_v1.plan_lives, ftf_plan_master_file_op_cdw_v1.pref_brand_tier, ftf_plan_master_file_op_cdw_v1.cycle_id, ftf_plan_master_file_op_cdw_v1.modified_time, ftf_plan_master_file_op_cdw_v1.product, ftf_plan_master_file_op_cdw_v1.paytype, ftf_plan_master_file_op_cdw_v1.ftf_health_plan_type) ALL NODES;

CREATE PROJECTION payerspine.paytype_product_coverage_category_cdw_v1_b0 /*+basename(paytype_product_coverage_category_cdw_v1),createtype(L)*/ 
(
 paytype,
 product,
 metric,
...
CREATE PROJECTION payerspine.paytype_product_copay_tier_cdw_v1_b0 /*+basename(paytype_product_copay_tier_cdw_v1),createtype(L)*/ 
(
 paytype,
 product,
 metric,
...
CREATE PROJECTION payerspine.paytype_product_step_category_cdw_v1_b0 /*+basename(paytype_product_step_category_cdw_v1),createtype(L)*/ 
(
 paytype,
 product,
 metric,
...
CREATE PROJECTION payerspine.paytype_product_patient_pa_cdw_v1_b0 /*+basename(paytype_product_patient_pa_cdw_v1),createtype(L)*/ 
(
 paytype,
 product,
 metric,
...
CREATE PROJECTION payerspine.key_controlling_account_product_cov_category_paytype_cdw_v1_b0 /*+basename(key_controlling_account_product_cov_category_paytype_cdw_v1),createtype(L)*/ 
(
 key_controlling_account,
 paytype,
 product,
...
CREATE PROJECTION payerspine.key_pbm_product_cov_category_paytype_cdw_v1_b0 /*+basename(key_pbm_product_cov_category_paytype_cdw_v1),createtype(L)*/ 
(
 key_pbm,
 paytype,
 product,
...
CREATE PROJECTION payerspine.payer_spine25_plan_teva_brands_cdw_v1_b0 /*+basename(payer_spine25_plan_teva_brands_cdw_v1),createtype(L)*/ 
(
 iqvia_plan_code,
 iqvia_plan_name,
 iqvia_payer_name,
...
CREATE PROJECTION payerspine.grouped_rest_ranking_control_b0 /*+basename(grouped_rest_ranking_control),createtype(L)*/ 
(
 restriction_group,
 rank_rest_grp
)
AS
 ...
 FROM payerspine.grouped_rest_ranking_control
...
CREATE PROJECTION payerspine.past_mapping_changes_b0 /*+basename(past_mapping_changes),createtype(L)*/ 
(
 Restrictions,
 Manual_update,
 restrictions_up,
...
AS
 ...
 FROM payerspine.past_mapping_changes
...
CREATE PROJECTION payerspine.ftf_restriction_id_group_mapping_v2_b0 /*+basename(ftf_restriction_id_group_mapping_v2),createtype(L)*/ 
(
 restriction_detail_id,
 restriction_detail_text,
 row_count,
...
AS
 ...
 ORDER BY ftf_restriction_id_group_mapping_v2.restriction_detail_id,
          ...
          ftf_restriction_id_group_mapping_v2.other_pmf_metrics,
          ftf_restriction_id_group_mapping_v2.file_id
SEGMENTED BY hash(ftf_restriction_id_group_mapping_v2.row_count, ftf_restriction_id_group_mapping_v2.file_id, ftf_restriction_id_group_mapping_v2.coverage_cat, ftf_restriction_id_group_mapping_v2.other_pmf_metrics, ftf_restriction_id_group_mapping_v2.restriction_detail_id, ftf_restriction_id_group_mapping_v2.restriction_group, ftf_restriction_id_group_mapping_v2.restriction_detail_text) ALL NODES;

CREATE PROJECTION payerspine.ftf_formularies_preprocessed_cdw_v3_b0 /*+basename(ftf_formularies_preprocessed_cdw_v3),createtype(L)*/ 
(
 drug_seq,
 ftf_health_plan_fid,
 drug_id,
...
CREATE PROJECTION payerspine.ftf_restrictions_preprocessed_cdw_v3_b0 /*+basename(ftf_restrictions_preprocessed_cdw_v3),createtype(L)*/ 
(
 health_plan_id,
 drug_id,
 drug_seq,
...
AS
 ...
 ORDER BY ftf_restrictions_preprocessed_cdw_v3.health_plan_id,
          ftf_restrictions_preprocessed_cdw_v3.drug_id,
          ftf_restrictions_preprocessed_cdw_v3.drug_seq,
          ftf_restrictions_preprocessed_cdw_v3.restriction_code,
          ftf_restrictions_preprocessed_cdw_v3.restriction_detail_id,
          ...
          ftf_restrictions_preprocessed_cdw_v3.restriction_group,
          ftf_restrictions_preprocessed_cdw_v3.coverage_cat
SEGMENTED BY hash(ftf_restrictions_preprocessed_cdw_v3.health_plan_id, ftf_restrictions_preprocessed_cdw_v3.drug_id, ftf_restrictions_preprocessed_cdw_v3.drug_seq, ftf_restrictions_preprocessed_cdw_v3.rank_rest_grp, ftf_restrictions_preprocessed_cdw_v3.botox, ftf_restrictions_preprocessed_cdw_v3.step, ftf_restrictions_preprocessed_cdw_v3.pres_pa, ftf_restrictions_preprocessed_cdw_v3.pat_pa) ALL NODES;

CREATE PROJECTION payerspine.plan_prod_master_cdw_v2_b0 /*+basename(plan_prod_master_cdw_v2),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
AS
 ...
 ORDER BY plan_prod_master_cdw_v2.ftf_health_plan_fid,
          plan_prod_master_cdw_v2.drug_seq
SEGMENTED BY hash(plan_prod_master_cdw_v2.ftf_health_plan_fid, plan_prod_master_cdw_v2.drug_seq) ALL NODES;

CREATE PROJECTION payerspine.ftf_plan_master_file_cdw_v2_b0 /*+basename(ftf_plan_master_file_cdw_v2),createtype(L)*/ 
(
 ftf_health_plan_fid,
 ftf_health_plan_name,
 ftf_provider_fid,
...
AS
 ...
 ORDER BY ftf_plan_master_file_cdw_v2.ftf_health_plan_fid,
          ...
          ftf_plan_master_file_cdw_v2.drug_id,
          ftf_plan_master_file_cdw_v2.drug_seq
SEGMENTED BY hash(ftf_plan_master_file_cdw_v2.ftf_health_plan_fid, ftf_plan_master_file_cdw_v2.drug_seq) ALL NODES;
