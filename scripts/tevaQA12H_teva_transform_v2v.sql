...
COPY /*73*/ teva_transform.teva_transform_lock FROM VERTICA teva.teva_transform.teva_transform_lock;
...
COPY /*17205046*/ teva_transform.teva_transform_log FROM VERTICA teva.teva_transform.teva_transform_log;
DISCONNECT teva;
