...
lname = 'log/get_'+bucket_key+'_access_policy.log'
logging.basicConfig(filename=lname, level=logging.INFO, format='%(asctime)s %(message)s')


config = {'in_fspec': 'sql/ap.sql', 'log': lname, 'export_type': 'csv', 
    'conn_type': 'src', 'schema': 'all_schemas', 'bucket_key': bucket_key}
